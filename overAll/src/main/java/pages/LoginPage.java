...
//        logger.info("button was clicked");
    ...
    public LoginPage clickOnButtonRegistration() {
        Util.waitABit(2);
        clickOnElement(buttonSignUp);
        return this;
    }

    public LoginPage checkButtonSignInDisplayed(){
        Assert.assertTrue("Button SignIn Is not displayed", isElementDisplayed(buttonSignIn));
        return this;
    }
}
