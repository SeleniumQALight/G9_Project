...
public class User {
    ...
    public final static String SHORT_PASSWORD_NOT_VALID = "ro";
    public final static String SHORT_EMAIL_NOT_VALID = "ro";
    ...
    public  User(String tcNumber){
        this.userName = tcNumber + "se" + faker.name().lastName() + Util.getDateAndTimeFormattedOnlyNumbers();
