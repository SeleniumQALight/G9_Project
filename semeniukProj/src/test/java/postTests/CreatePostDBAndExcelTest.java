...
public class CreatePostDBAndExcelTest extends BaseTest {
    Logger logger = Logger.getLogger(getClass());
    String title;

    @Test
    @Parameters(method = "parametersForCreatingPost")
    public void TC_004_createNewPost(String postTitle, String body, String dropdown, String state, String expectedMessage, String expectedState) throws Exception {
