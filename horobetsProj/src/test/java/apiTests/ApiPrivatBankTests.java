...
public class ApiPrivatBankTests {
    ...
    public void getAllExchangeRates() {
        ...
        ExchangeRatesDto expectedResponseDto = new ExchangeRatesDto
                ("22.03.2022", "PB", 980, "UAH", currencyDto);

        Assert.assertEquals("Number of exchange rates "
                , expectedResponseDto.getExchangeRate().size()
                , actualResponseAsDto.getExchangeRate().size());
