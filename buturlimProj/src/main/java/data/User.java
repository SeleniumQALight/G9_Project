...
public class User {
    ...
    public final static String SHORT_PASSWORD_NOT_VALID = "ff";
    public final static String SHORT_EMAIL_NOT_VALID = "ff";
    ...
    public User(String tcNumber){
        this.userName = tcNumber + "bu" + faker.name().firstName() + Util.getDateAndTimeFormattedOnlyNumbers();
        this.email = this.userName + "@mail.com";
