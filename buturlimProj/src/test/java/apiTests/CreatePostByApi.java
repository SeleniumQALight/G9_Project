...
public class CreatePostByApi {
    ...
    public void createPostByApi() {
        int numberOfPostsBeforeCreatingPost = apiHelper.getAllPostsByUserRequest()
                .extract()
                .response().as(PostsDto[].class).length;
        ...
        Assert.assertEquals("Number of posts ", numberOfPostsBeforeCreatingPost + 1, numberOfPostsAfterCreatingPost);
