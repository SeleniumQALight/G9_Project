...
public class SignOutTest extends BaseTest {
    ...
    public void TC_002_signOutTest() {
        ...
        Assert.assertTrue("User Name input is not displayed", pageProvider.getLoginPage().isUserNameInputDisplayed());
        Assert.assertTrue("Password input is not displayed", pageProvider.getLoginPage().isPasswordInputDisplayed());
        Assert.assertTrue("Button Sign In is not displayed", pageProvider.getHomePage().isButtonSignInDisplayed());
