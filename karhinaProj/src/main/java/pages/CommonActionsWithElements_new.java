...
public class CommonActionsWithElements_new {
    ...
    public CommonActionsWithElements_new(WebDriver webDriver) {
        ...
        webDriverWait15 = new WebDriverWait(webDriver, Duration.ofSeconds(ConfigProvider.configProperties.TIME_FOR_EXPLICIT_WAIT_HIGH()));
    }
...
//        try {
            ...
            Assert.assertEquals("Text in element not matched", expectedText, actualText);
